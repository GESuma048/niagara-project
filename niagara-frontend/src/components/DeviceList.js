...
class DeviceList extends Component{
    render(){
        console.log('this.props',this.props); //prints the current state
        return(
            <div>
            <h3 className="h3">Device Value</h3>
            {
                //loop over devices array and map each element to a table
...
//gets the entire store state and returns it for the component to use
